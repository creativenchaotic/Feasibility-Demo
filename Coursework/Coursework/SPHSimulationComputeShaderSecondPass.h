...
public:
	...
	void setSimulationDataSRV(ID3D11DeviceContext* deviceContext, ID3D11ShaderResourceView* computeShaderSRVspatialIndices, ID3D11ShaderResourceView* computeShaderSRVspatialOffsets);
