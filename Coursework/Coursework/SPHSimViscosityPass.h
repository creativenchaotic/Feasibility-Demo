#pragma once
#include "DXF.h"
class SPHSimViscosityPass : public BaseShader
{
public:
	SPHSimViscosityPass(ID3D11Device* device, HWND hwnd);
	~SPHSimViscosityPass();
	...
	void setSimulationDataSRV(ID3D11DeviceContext* deviceContext, ID3D11ShaderResourceView* sphSimPressureForceOutput);
