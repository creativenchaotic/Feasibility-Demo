...
void OffsetCalculationComputeShader::createOutputUAVs(ID3D11Device* pd3dDevice, int numParticles, std::vector<ParticleData>* particles)
{
    ...
    pd3dDevice->CreateBuffer(&bufferDesc, (particles) ? &bufferInitData : nullptr, &offsetCalculationsOutput);//Creates the buffer
