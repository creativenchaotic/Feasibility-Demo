...
void OffsetCalculationComputeShader::createOutputUAVs(ID3D11Device* pd3dDevice, int numParticles)
{
    ...
    pd3dDevice->CreateBuffer(&bufferDesc, nullptr, &offsetCalculationsOutput);//Creates the buffer
